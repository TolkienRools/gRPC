...
func (c *bikeServiceClient) GetBikes(ctx context.Context, in *GetBikesRequest, opts ...grpc.CallOption) (*GetBikesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/bike.BikeService/GetBikes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bikeServiceClient) AddBike(ctx context.Context, in *AddBikeRequest, opts ...grpc.CallOption) (*AddBikeResponse, error) {
	out := new(AddBikeResponse)
	err := c.cc.Invoke(ctx, "/bike.BikeService/AddBike", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBikeServiceServer) AddBike(context.Context, *AddBikeRequest) (*AddBikeResponse, error) {
...
func _BikeService_GetBikes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bike.BikeService/GetBikes",
	}
...
func _BikeService_AddBike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddBikeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BikeServiceServer).AddBike(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bike.BikeService/AddBike",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BikeServiceServer).AddBike(ctx, req.(*AddBikeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BikeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddBike",
			Handler:    _BikeService_AddBike_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "bike_rpc/bike.proto",
}
